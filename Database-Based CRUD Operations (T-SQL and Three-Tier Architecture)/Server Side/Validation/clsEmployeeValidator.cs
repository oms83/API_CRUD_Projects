...
namespace Server_Side.Validation
{
    public class clsEmployeeValidator : AbstractValidator<clsEmployeeDTO>
    {
        private clsEmployeeValidator(bool withId)
        {
        ...
        public static clsEmployeeValidator Validator(bool ValidateWithID)
        {
            if (ValidateWithID)
            {
                return new clsEmployeeValidator(true);
            }
            else
            {
                return new clsEmployeeValidator();
            }
        }
    }
}
